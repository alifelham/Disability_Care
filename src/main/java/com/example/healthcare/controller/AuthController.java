...
import com.example.healthcare.payload.AuthResponse;
import com.example.healthcare.payload.LoginRequest;
import com.example.healthcare.payload.SignUpRequest;
...
public class AuthController {
    ...
    public ResponseEntity<?> registerUser(@Valid @RequestBody SignUpRequest signUpRequest) throws ExecutionException, InterruptedException {
        System.out.println("In register user: " + signUpRequest.getEmail());
        ...
        User result = userRepository.savee(user);
